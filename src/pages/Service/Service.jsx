        ...
        <div className="md:flex mx-auto justify-around gap-5 ">
            <div className="card w-full md:w-72 bg-base-100 shadow-xl">
                ...
                <div className="card-body items-center text-center">
                    ...
                    <p>Description: Optimize engine performance for improved power, efficiency, and acceleration. Unleash your cars full potential!</p>
                    <div className="card-actions">
                        <button className="btn btn-outline btn-sm btn-primary">Price: $200</button>
                    </div>
                </div>
            </div>
            <div className="card w-full md:w-72 bg-base-100 shadow-xl">
                ...
                <div className="card-body items-center text-center">
                    ...
                    <p>Description: Boost torque output for enhanced towing capacity and acceleration. Conquer challenges with increased power.</p>
                    <div className="card-actions">
                        <button className="btn btn-outline btn-sm btn-primary">Price: $150</button>
                    </div>
                </div>
            </div>
            <div className="card w-full md:w-72 bg-base-100 shadow-xl">
                ...
                <div className="card-body items-center text-center">
                    ...
                    <p>Description: Upgrade suspension and install high-performance tires for ultimate grip, control, and thrilling driving experience.</p>
                    <div className="card-actions">
                        <button className="btn btn-outline btn-sm btn-primary">Price: $175</button>
                    </div>
                </div>
            </div>
        </div>
